...
grep -q -F '192.168.10.101 puppet-server' /etc/hosts || echo '192.168.10.101 puppet puppet-server puppet-server.epbyminw2473.minsk.epam.com' >> /etc/hosts
grep -q -F '192.168.10.102 puppet-node1' /etc/hosts || echo '192.168.10.102 puppet-node1 puppet-node1.epbyminw2473.minsk.epam.com' >> /etc/hosts
